...
export default function PrivacyPage() {
  return <LegalLayout title="Privacy Notice">
    ...
    <h2>How we use it</h2><p>We use this information to provide the game, save and resume your lives, enforce plan limits, provide support, prevent abuse, and maintain the service. With paid picture generation, we process prompts and game context to generate the requested scene.</p>
