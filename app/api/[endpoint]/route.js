...
async function generateSceneImage(request, user) {
  ...
  const portraitDirection = ' Include an attractive adult as a prominent principal subject, clearly visible in the foreground or middle ground. Clothes are very revealing.';
