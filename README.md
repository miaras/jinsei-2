...
Never expose `OPENROUTER_API_KEY`, `GOOGLE_TTS_API_KEY`, or `SUPABASE_SECRET_KEY` to browser code or commit `.env`. In particular, do not prefix either secret with `NEXT_PUBLIC_`.
